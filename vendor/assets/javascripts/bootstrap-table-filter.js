!function($) {
    ...
    BootstrapTableFilter.FILTER_SOURCES = {
        range: {
            search: false,
            rows: [
                {id: 'eq', label: '{%msg} <input class="form-control" type="text">', i18n: {msg: 'Égal à'}},
                {id: 'gte', label: '{%msg} <input class="form-control" type="text">', i18n: {msg: 'Plus que'}},
                {id: 'lte', label: '{%msg} <input class="form-control" type="text">', i18n: {msg: 'Moins que'}}
            ],
        ...
        search: {
            ...
            rows: [
                {id: 'eq', label: '{%msg} <input class="form-control" type="text">', i18n: {msg: 'Égal à'}},
                {id: 'neq', label: '{%msg} <input class="form-control" type="text">', i18n: {msg: 'Non égal à'}},
                {id: 'cnt', label: '{%msg} <input class="form-control" type="text">', i18n: {msg: 'Contient'}},
                {id: 'ncnt', label: '{%msg} <input class="form-control" type="text">', i18n: {msg: 'Ne contient pas'}},
                {id: 'ept', label: '{%msg}', i18n: {msg: 'Est vide'}},
                {id: 'nept', label: '{%msg}', i18n: {msg: 'N\'est pas vide'}}
            ],
            check: function(filterData, value) {
